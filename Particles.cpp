...
void ParticleSystem::update(Game* g) {
    for (Particle*& p : this->particles) {
        ...
        bool collide = g->balls[0]->circintersects(p->position, g->paddles[0]->position, 3.0f, 1.5, 17.0);
        bool collide2 = g->balls[0]->circintersects(p->position, g->paddles[1]->position, 3.0f, 1.5, 17.0);
